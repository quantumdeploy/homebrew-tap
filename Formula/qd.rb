class Qd < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://api.quantumdeploy.ai/releases/v1.0.0/qd_1.0.0_darwin_arm64.tar.gz"
      sha256 "f426f180ea7e4d02ade87c2af0a185a9f8656842e4ee33704f5c5f044b8515ce"
    else
      url "https://api.quantumdeploy.ai/releases/v1.0.0/qd_1.0.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://api.quantumdeploy.ai/releases/v1.0.0/qd_1.0.0_linux_arm64.tar.gz"
      sha256 "2c48acf906f14691386ac0bc3e6c46116837d1a18f87a2479f2c022392463301"
    else
      url "https://api.quantumdeploy.ai/releases/v1.0.0/qd_1.0.0_linux_amd64.tar.gz"
